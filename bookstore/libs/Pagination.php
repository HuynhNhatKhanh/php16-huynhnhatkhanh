	...
	public function showPagination(){
		...
		if($this->totalPage > 1){
			...
			if($this->currentPage > 1){
				$start 	= '<li class="page-item"><a class="page-link" href="'.ROOT_URL.'?controller=rss&action=index&page=1">Start</a></li>';
				$prev 	= '<li class="page-item"><a class="page-link" href="'.ROOT_URL.'?controller=rss&action=index&page='.($this->currentPage-1).'">Previous</a></li>';
			}
			...
			if($this->currentPage < $this->totalPage){
				$next 	= '<li class="page-item"><a class="page-link" href="'.ROOT_URL.'?controller=rss&action=index&page='.($this->currentPage+1).'">Next</a></li>';
				$end 	= '<li class="page-item"><a class="page-link" href="'.ROOT_URL.'?controller=rss&action=index&page='.$this->totalPage.'">End</a></li>';
			}
			...
			for($i = $startPage; $i <= $endPage; $i++){
				if($i == $this->currentPage) {
					$listPages .= '<li class="page-item active"><a class="page-link">'.$i.'</a>';
				}else{
					$listPages .= '<li class="page-item"><a class="page-link" href="'.ROOT_URL.'?controller=rss&action=index&page='.$i.'">'.$i.'</a>';
				}
			}
