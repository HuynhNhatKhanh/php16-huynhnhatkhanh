...
class UserModel extends Model
{
	...
	{
		$query[] = "SELECT DISTINCT `$this->table`.`group_id`, `$this->table`.`id`,`$this->table`.`username`, `$this->table`.`email`,`$this->table`.`fullname`, `$this->table`.`password`, `$this->table`.`created`, `$this->table`.`created_by`, `$this->table`.`modified`, `$this->table`.`modified_by`, `$this->table`.`status`, `$this->table`.`group_acp`, `$this->table`.`ordering`";
		$query[]     = "FROM `$this->table`";
