<?php 
    ...
    foreach ($this->items as $key => $item) {
        ...
        $groupAcp = Helper::showItemGroupAcp($id, $item['group_acp']);
        $iconEdit = Helper::showAction($id, 'edit');
        $iconDelete = Helper::showAction($id, 'delete');
        ...
        <td class="text-center">'.$iconEdit.$iconDelete.'</td>
    </tr>';
